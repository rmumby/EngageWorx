...
{  
  ...
  excerpt: "Stop sending your clients to third-party messaging platforms. Learn how white-labeling the channel can generate 50-75% margins and make your business stickier.",
  content: `
...
export default function Blog({ onBack }) {
  var selectedPost = useState(null);
  var selectedPostVal = selectedPost[0];
  var setSelectedPost = selectedPost[1];
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.bg, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        <div
          onClick={function() { setSelectedPost(null); onBack(); }}
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
          ...
          <span
            onClick={function() { setSelectedPost(null); }}
      ...
      {/* Content */}
      {selectedPostVal
        ? <BlogPost slug={selectedPostVal} onBack={function() { setSelectedPost(null); }} />

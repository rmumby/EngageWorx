...
export default function AIChatbot({ C, tenants, viewLevel = "tenant", currentTenantId, demoMode = false, onNavigate }) {
  ...
  const [systemPrompt, setSystemPrompt] = useState("You are a helpful customer support assistant. Be friendly, accurate, and concise. Always try to resolve the customer's issue, and escalate to a human agent if needed.");

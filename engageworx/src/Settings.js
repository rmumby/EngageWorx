...
export default function Settings({ C, tenants, viewLevel = "tenant", currentTenantId, demoMode = true }) {
  ...
  const CHANNEL_DEFS = [
    ...
    { id: "voice", label: "Voice", icon: "📞", color: "#FFD600", fields: [
      ...
      { key: "tts_voice", label: "TTS Voice", type: "select", options: [{ key: "ai_agent_name", label: "AI Agent Name", placeholder: "Eva" },
      { key: "tts_voice", label: "TTS Voice", type: "select", options: ["Polly.Joanna (US Female)", "Polly.Joanna-Neural (US Female, Natural)", "Polly.Kendra (US Female)", "Polly.Kendra-Neural (US Female, Natural)", "Polly.Kimberly (US Female)", "Polly.Salli (US Female)", "Polly.Salli-Neural (US Female, Natural)", "Polly.Ivy-Neural (US Female, Young)", "Polly.Ruth-Neural (US Female, Newest)", "Polly.Amy (UK Female)", "Polly.Amy-Neural (UK Female, Natural)", "Polly.Emma (UK Female)", "Polly.Emma-Neural (UK Female, Natural)", "Polly.Matthew (US Male)", "Polly.Matthew-Neural (US Male, Natural)", "Polly.Joey (US Male)", "Polly.Joey-Neural (US Male, Natural)", "Polly.Stephen-Neural (US Male, Newest)", "Polly.Brian (UK Male)", "Polly.Brian-Neural (UK Male, Natural)", "Polly.Arthur-Neural (UK Male)", "Polly.Olivia-Neural (AU Female)", "Polly.Nicole (AU Female)", "Polly.Russell (AU Male)", "Polly.Kajal-Neural (Indian English Female)"] },

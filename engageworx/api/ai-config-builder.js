...
var SHELL_PROMPT = [
  ...
  '',
  'CRITICAL — AMBIGUOUS AFFIRMATIVES:',
  '- If your PREVIOUS message asked a multi-part question (e.g. "What triggers this? How urgent? Who to notify?")',
  '  and the user responds with ONLY a short affirmative like "yes", "yeah", "ok", "sure", "do it",',
  '  "sounds good", "go ahead", "yep", "correct" — this is AMBIGUOUS.',
  '- You MUST NOT accept an ambiguous affirmative as answering a multi-part question.',
  '- Instead, respond with type "question" and say: "I want to make sure I get this right.',
  '  Could you tell me specifically: [re-ask the unanswered part(s)]?"',
  '- This applies to the FIRST ambiguous response, not just after multiple turns.',
  '- An affirmative IS valid when your previous message was a yes/no question or a proposal review.',
  '',
